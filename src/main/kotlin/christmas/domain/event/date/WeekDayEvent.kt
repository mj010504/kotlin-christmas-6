...
class WeekDayEvent(override val visitDay: VisitDay, override val quantity: Int) : DateEvent()  {
    override val name = "평일 할인"

    override fun getDiscountAmount(): Int {
        val date = LocalDate.of(2023, 12, visitDay.day)
        val dayOfWeek = date.dayOfWeek
        if(dayOfWeek in DayOfWeek.MONDAY..DayOfWeek.FRIDAY) return DISCOUNT_AMOUNT * quantity
        return 0
    }
